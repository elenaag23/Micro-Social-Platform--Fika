...
namespace MS_Fika.Data.Migrations
{
    ...
    [Migration("20230107130050_Migratie12")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MS_Fika.Models.Friend", b =>
                {
                    ...
                    b.Property<string>("UserAdaugatId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("UserCareAdaugaId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("FriendId");

                    b.HasIndex("UserAdaugatId");

                    b.HasIndex("UserCareAdaugaId");
            ...
            modelBuilder.Entity("MS_Fika.Models.Friend", b =>
                {
                    b.HasOne("MS_Fika.Models.ApplicationUser", "UserAdaugat")
                        .WithMany()
                        .HasForeignKey("UserAdaugatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MS_Fika.Models.ApplicationUser", "UserCareAdauga")
                        .WithMany()
                        .HasForeignKey("UserCareAdaugaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserAdaugat");

                    b.Navigation("UserCareAdauga");
                });
